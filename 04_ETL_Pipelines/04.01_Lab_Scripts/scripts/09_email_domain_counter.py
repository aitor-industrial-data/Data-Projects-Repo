################################################################################
# 09_email_domain_counter.py
# AUTOR: Aitor | Ingeniero Técnico Industrial | Data Engineer
# PROYECTO: ETL Pipeline - Extracción de Dominios y Persistencia en SQLite
#
# ENUNCIADO:
# Desarrollar un proceso ETL (Extract, Transform, Load) que analice registros
# de comunicación para identificar patrones organizacionales. El sistema debe:
# 1. Conectarse a un endpoint remoto para extraer datos de logs de correo (mbox.txt).
# 2. Implementar 'User-Agent' Spoofing para garantizar el acceso al servidor web.
# 3. Transformar strings de texto plano para aislar dominios mediante técnicas 
#    de slicing y limpieza de datos (Data Wrangling).
# 4. Cargar la información en una base de datos SQLite, utilizando lógica de
#    UPSERT (Update or Insert) para gestionar contadores de frecuencia.
# 5. Optimizar la latencia de escritura mediante el manejo estratégico de 
#    transacciones (Comit deferred).
#
# FOCO TÉCNICO: SQL-Python Integration, ETL Architecture, Web Scraping Basics.
################################################################################
