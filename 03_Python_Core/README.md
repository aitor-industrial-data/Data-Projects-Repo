# 03_ Python Core: Fundamentos para Ingeniería de Datos
...
| :--- | :--- | :--- | :--- |
| 06 | [`voltage_drop_calculator.py`](./03.01_python_foundations/scripts/06_voltage_drop_calculator.py) | Funciones I | Cálculo de caída de tensión basado en longitud, sección y material. |
| 15 | [`automated_folder_sorter.py`](./03.03_system_automation_lab/scripts/15_automated_folder_sorter.py) | Automatización OS | Clasificación automática de datasets por extensión (.csv, .json, .log). |
| 20 | [`text_data_cleaner.py`](./03.04_data_processing_scripts/scripts/20_text_data_cleaner.py) | Limpieza de Datos | Normalización de strings y eliminación de caracteres especiales en archivos masivos. |
| 22 | [`asset_management_oop.py`](./03.04_data_processing_scripts/scripts/22_asset_management_oop.py) | OOP Avanzado | Gestión de activos (motores eléctricos) mediante clases, potencia y horas de uso. |
| 26 | [`csv_to_sqlite_bulk.py`](./03.04_data_processing_scripts/scripts/26_csv_to_sqlite_bulk.py) | Carga de Datos | Ingestión masiva de registros CSV hacia tablas estructuradas en SQLite. |
